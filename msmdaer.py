...
def cross_subject(session_id, category_number, batch_size, iteration, lr, momentum, log_interval):
    ...
    train_dataset, test_dataset = get_dataset(
        {"dataset": "SEED", "feature": "de_LDS", "subjects": 15}, session_id, 14)
    source_loaders = []
    for j in range(14):
        source_loaders.append(torch.utils.data.DataLoader(dataset=train_dataset,
                                                          batch_size=batch_size,
                                                          shuffle=True,
                                                          drop_last=True))
    target_loader = torch.utils.data.DataLoader(dataset=test_dataset,
                                                batch_size=batch_size,
                                                shuffle=True,
                                                drop_last=True)
